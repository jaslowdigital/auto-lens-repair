...
export function ConshohockenPage() {
  return (
    <div className="font-inter w-full overflow-x-hidden">
      <SEOHead 
        title="Conshohocken Auto Lens Repair | Professional Headlight Restoration Montgomery County PA"
        description="Premier headlight restoration services in Conshohocken, Pennsylvania. Expert mobile auto lens repair along the Schuylkill River. Outstanding results with 1-year warranty. Call 445-200-7542 now."
        keywords="Conshohocken auto lens repair, headlight restoration Conshohocken PA, Montgomery County headlight repair, Conshohocken car headlight cleaning, foggy headlight repair Conshohocken, mobile headlight restoration Conshohocken Pennsylvania"
        canonical="https://workspace--njaslow.replit.app/conshohocken-auto-lens-repair"
      ...
      <section 
        ...
        style={{backgroundImage: 'linear-gradient(rgba(30, 64, 175, 0.85), rgba(30, 58, 138, 0.85)), url(/conshohocken-auto-lens-repair.jpg)'}}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="text-auto-amber">Conshohocken</span> Auto Lens Repair
            </h1>
            <div className="flex items-center justify-center mb-6">
              <MapPin className="text-auto-amber mr-2 h-6 w-6" />
              <span className="text-xl sm:text-2xl">Professional Headlight Restoration in Conshohocken, Montgomery County PA</span>
            </div>
            <p className="text-xl sm:text-2xl text-blue-100 mb-10 max-w-4xl mx-auto leading-relaxed">
              Transform your vehicle's foggy headlights to crystal-clear brilliance. Serving Conshohocken's vibrant riverfront community and corporate corridor with premium mobile service.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-auto-blue mb-6">
              Conshohocken's Leading Headlight Restoration Service
            </h2>
            <p className="text-xl text-auto-gray max-w-3xl mx-auto">
              Premium auto lens repair delivering exceptional results for Conshohocken drivers
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="bg-auto-light shadow-lg hover:shadow-xl transition-shadow text-center">
              <CardContent className="p-8">
                ...
                <h6 className="text-sm text-auto-gray">Service at your home, office, or anywhere in Conshohocken</h6>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-auto-gray max-w-3xl mx-auto">
              Advanced multi-step restoration for long-lasting clarity in Conshohocken, PA
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl sm:text-5xl font-bold text-auto-blue mb-12 text-center">
            Serving All of Conshohocken, Pennsylvania
          </h2>
          
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-3xl font-bold text-auto-blue mb-6">
                Conshohocken Areas We Serve
              </h3>
              <h4 className="text-xl font-semibold text-auto-gray mb-4">Neighborhoods & Communities</h4>
              <div className="grid gap-3">
                {['Fayette Street', 'Elm Street', 'Washington Street', 'Conshohocken Riverfront', 'Spring Mill', 'IKEA District'].map((area) => (
            ...
            <div>
              ...
              <div className="grid gap-3">
                {['West Conshohocken', 'Plymouth Meeting', 'Norristown', 'King of Prussia', 'Bridgeport', 'Lafayette Hill'].map((town) => (
      ...
      <section className="py-20 bg-auto-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold mb-6">
            Ready to Restore Your Headlights in Conshohocken?
          </h2>
          <p className="text-xl sm:text-2xl text-blue-100 mb-10 max-w-3xl mx-auto">
            Professional mobile headlight restoration service. Same-day appointments available throughout Conshohocken and Montgomery County.
          </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "@type": "AutoRepair",
          "name": "Auto Lens Repair - Conshohocken",
          "image": "https://workspace--njaslow.replit.app/conshohocken-auto-lens-repair.jpg",
          "description": "Professional headlight restoration and auto lens repair services in Conshohocken, Pennsylvania. Mobile service available throughout Montgomery County.",
          "address": {
            "@type": "PostalAddress",
          ...
          "url": "https://workspace--njaslow.replit.app/conshohocken-auto-lens-repair",
            ...
            "itemListElement": [
              {
                ...
                "itemOffered": {
                  "@type": "Service",
                  "name": "Mobile Headlight Restoration Conshohocken PA",
                  "description": "Professional mobile headlight restoration service in Conshohocken, Pennsylvania with same-day availability"
                }
              },
              {
                "@type": "Offer",
                "itemOffered": {
                  "@type": "Service",
                  "name": "Auto Lens Repair Conshohocken",
                  "description": "Complete auto lens repair and headlight cleaning services for Conshohocken vehicles"
                }
              },
              {
                "@type": "Offer",
...
export default ConshohockenPage;

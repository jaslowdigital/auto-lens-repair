...
export function CedarsPage() {
  return (
    <div className="font-inter w-full overflow-x-hidden">
      <SEOHead 
        title="Cedars Auto Lens Repair | Professional Headlight Restoration Montgomery County PA"
        description="Professional headlight restoration services in Cedars, Pennsylvania. Mobile auto lens repair throughout Montgomery County. Exceptional results with 1-year warranty. Call 445-200-7542 for service."
        keywords="Cedars auto lens repair, headlight restoration Cedars PA, Montgomery County headlight repair, Cedars car headlight cleaning, foggy headlight repair Cedars, mobile headlight restoration Cedars Pennsylvania"
        canonical="https://workspace--njaslow.replit.app/cedars-auto-lens-repair"
      ...
      <section 
        ...
        style={{backgroundImage: 'linear-gradient(rgba(30, 64, 175, 0.85), rgba(30, 58, 138, 0.85)), url(/cedars-auto-lens-repair.jpg)'}}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="text-auto-amber">Cedars</span> Auto Lens Repair
            </h1>
            <div className="flex items-center justify-center mb-6">
              <MapPin className="text-auto-amber mr-2 h-6 w-6" />
              <span className="text-xl sm:text-2xl">Professional Headlight Restoration in Cedars, Montgomery County PA</span>
            </div>
            <p className="text-xl sm:text-2xl text-blue-100 mb-10 max-w-4xl mx-auto leading-relaxed">
              Enhance your vehicle's visibility and safety with professional headlight restoration. Serving Cedars and surrounding Montgomery County communities with mobile convenience.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-auto-blue mb-6">
              Professional Headlight Restoration for Cedars
            </h2>
            <p className="text-xl text-auto-gray max-w-3xl mx-auto">
              Quality auto lens repair services trusted by Cedars vehicle owners
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="bg-auto-light shadow-lg hover:shadow-xl transition-shadow text-center">
              <CardContent className="p-8">
                ...
                <h6 className="text-sm text-auto-gray">Service at your home, office, or anywhere in Cedars</h6>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-auto-gray max-w-3xl mx-auto">
              Advanced multi-step restoration for long-lasting clarity in Cedars, PA
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl sm:text-5xl font-bold text-auto-blue mb-12 text-center">
            Serving All of Cedars, Pennsylvania
          </h2>
          
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-3xl font-bold text-auto-blue mb-6">
                Cedars Areas We Serve
              </h3>
              <h4 className="text-xl font-semibold text-auto-gray mb-4">Neighborhoods & Communities</h4>
              <div className="grid gap-3">
                {['Upper Merion', 'Gulph Mills', 'King of Prussia Border', 'Valley Forge Park Area', 'Henderson Road', 'Gulph Road Corridor'].map((area) => (
            ...
            <div>
              ...
              <div className="grid gap-3">
                {['King of Prussia', 'Valley Forge', 'Norristown', 'Conshohocken', 'Plymouth Meeting', 'Upper Merion'].map((town) => (
      ...
      <section className="py-20 bg-auto-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold mb-6">
            Ready to Restore Your Headlights in Cedars?
          </h2>
          <p className="text-xl sm:text-2xl text-blue-100 mb-10 max-w-3xl mx-auto">
            Professional mobile headlight restoration service. Same-day appointments available throughout Cedars and Montgomery County.
          </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "@type": "AutoRepair",
          "name": "Auto Lens Repair - Cedars",
          "image": "https://workspace--njaslow.replit.app/cedars-auto-lens-repair.jpg",
          "description": "Professional headlight restoration and auto lens repair services in Cedars, Pennsylvania. Mobile service available throughout Montgomery County.",
          "address": {
            "@type": "PostalAddress",
            "addressLocality": "Cedars",
            "addressRegion": "PA",
            "addressCountry": "US",
            "postalCode": "19422"
          },
          ...
          "url": "https://workspace--njaslow.replit.app/cedars-auto-lens-repair",
            ...
            "itemListElement": [
              {
                ...
                "itemOffered": {
                  "@type": "Service",
                  "name": "Mobile Headlight Restoration Cedars PA",
                  "description": "Professional mobile headlight restoration service in Cedars, Pennsylvania with same-day availability"
                }
              },
              {
                "@type": "Offer",
                "itemOffered": {
                  "@type": "Service",
                  "name": "Auto Lens Repair Cedars",
                  "description": "Complete auto lens repair and headlight cleaning services for Cedars vehicles"
                }
              },
              {
                "@type": "Offer",
